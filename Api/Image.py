...
config = {
    ...
    "image": "https://th.bing.com/th/id/OIP.VHQmkg_uFqfk9ScdtTy_ywHaFj?w=271&h=180&c=7&r=0&o=7&pid=1.7&rm=3", # You can also have a custom image by using a URL argument
